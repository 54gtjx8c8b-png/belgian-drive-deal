...
const brands = ["Audi", "BMW", "Mercedes", "Volkswagen", "Peugeot", "Renault", "Toyota", "Tesla"];
const budgets = ["< 10 000€", "10 000€ - 20 000€", "20 000€ - 35 000€", "35 000€ - 50 000€", "> 50 000€"];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 animate-fade-up" style={{ animationDelay: '0.2s' }}>
            Des milliers de véhicules vérifiés, avec Car-Pass et compatibilité LEZ garantie
          </p>

          {/* Search Box */}
          <div className="glass-panel p-3 md:p-4 max-w-3xl mx-auto animate-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              {/* Search Button */}
              <button className="btn-primary-gradient flex items-center justify-center gap-2">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 mt-12 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <div className="text-center">
              <div className="font-display text-3xl md:text-4xl font-bold text-foreground">15K+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground text-sm">Vendeurs pro</div>
            </div>
          </div>
        </div>
      </div>
